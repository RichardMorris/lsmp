...
typedef enum
 {NONE, VERTEX, X_AXIS, Y_AXIS, Z_AXIS,FACE} soltype;
...
extern make_face(face_info *,int,int,int);
extern make_sub_faces(face_info *,
		face_info *,face_info *,face_info *,face_info *);
extern sol_info *make_sol(soltype,int,int,int,double);
extern sol_info *make_sol2(soltype,int,int,int,double,double);
extern face_info *get_face(int,int,int);
